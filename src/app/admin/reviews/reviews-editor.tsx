    ...
    <div className="mt-6 space-y-3">
      {branches.length > 0 && (
        <div className="flex items-center gap-3">
          <select value={branchFilter} onChange={(e) => setBranchFilter(e.target.value)} className="rounded-lg border border-white/10 bg-ink-900 px-4 py-2 text-sm font-bold text-cream">
