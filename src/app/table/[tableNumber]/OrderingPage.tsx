...
export function OrderingPage({
  ...
  return (
    <div className="min-h-screen bg-[#f5ead8] pb-24">
      <div className="sticky top-0 z-10 bg-[#f5ead8]/90 backdrop-blur border-b border-ink-950/10 px-4 py-3">
        <div className="flex items-center justify-between">
          <div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="min-h-9 min-w-9 rounded-lg border border-ink-950/10 bg-white px-2 text-xs font-black text-ink-700"
            >
              {lang === "ar" ? "EN" : "ع"}
            </button>
          <button
            onClick={() => setCartOpen(true)}
            className="relative flex items-center gap-2 rounded-full bg-brand-500 px-4 py-2 text-sm font-black text-cream shadow-md"
          >
            <ShoppingBag size={16} />
            {cartCount > 0 && (
              <motion.span
        ...
        {cartOpen && (
          ...
          >
            <motion.div
              ...
              className="absolute right-0 top-0 bottom-0 w-full max-w-sm bg-ink-950 shadow-2xl flex flex-col"
              dir="ltr"
            >
        ...
        {sizePicker && (
          ...
          >
            <motion.div
              ...
              exit={{ y: 100, opacity: 0 }}
              onClick={(e) => e.stopPropagation()}
              className="w-full max-w-sm rounded-t-2xl sm:rounded-2xl bg-ink-950 p-6"
            >
